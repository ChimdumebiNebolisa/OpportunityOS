...
| Automation | `scout_runs`, `discovery_runs`, `search_branches` | V1/V2 scout compatibility and V3 global run, lens, budget, saturation, reallocation, and coverage state are durable. |
